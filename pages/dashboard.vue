<template>
  ...
  <div class="flex gap-4">
    ...
    <button>
      ...
      >
        ...
        />
        <path
          d="M18.536 32.8V18.4H16.136V16H19.736C20.0542 16 20.3595 16.1264 20.5845 16.3515C20.8096 16.5765 20.936 16.8817 20.936 17.2V31.6H35.8616L38.2616 22H23.336V19.6H39.8C39.9824 19.6 40.1624 19.6416 40.3263 19.7216C40.4902 19.8016 40.6338 19.9179 40.746 20.0617C40.8582 20.2055 40.9362 20.373 40.9739 20.5515C41.0117 20.7299 41.0083 20.9147 40.964 21.0916L37.964 33.0916C37.899 33.3511 37.7491 33.5814 37.5382 33.746C37.3273 33.9106 37.0675 34 36.8 34H19.736C19.4177 34 19.1125 33.8736 18.8875 33.6485C18.6624 33.4235 18.536 33.1183 18.536 32.8ZM20.936 41.2C20.2995 41.2 19.689 40.9471 19.2389 40.4971C18.7888 40.047 18.536 39.4365 18.536 38.8C18.536 38.1635 18.7888 37.553 19.2389 37.1029C19.689 36.6529 20.2995 36.4 20.936 36.4C21.5725 36.4 22.183 36.6529 22.633 37.1029C23.0831 37.553 23.336 38.1635 23.336 38.8C23.336 39.4365 23.0831 40.047 22.633 40.4971C22.183 40.9471 21.5725 41.2 20.936 41.2ZM35.336 41.2C34.6995 41.2 34.089 40.9471 33.6389 40.4971C33.1888 40.047 32.936 39.4365 32.936 38.8C32.936 38.1635 33.1888 37.553 33.6389 37.1029C34.089 36.6529 34.6995 36.4 35.336 36.4C35.9725 36.4 36.583 36.6529 37.033 37.1029C37.4831 37.553 37.736 38.1635 37.736 38.8C37.736 39.4365 37.4831 40.047 37.033 40.4971C36.583 40.9471 35.9725 41.2 35.336 41.2Z"
          fill="white"
        />
      </svg>
    </button>
  ...
  <div
    class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 py-8 px-6 w-full container mx-auto"
  >
    <DetailsCard
      img="/bag1.png"
